python3 train_seg.py test \
  --dataroot ../dataset/Data_gen_256/test/single \
  --test_dataroot ../dataset/Data_gen_256/test/single \
  ...
  --checkpoint /root/autodl-fs/MeshMAE-mesh/checkpoints/alien/best_encoder_0.91.pkl