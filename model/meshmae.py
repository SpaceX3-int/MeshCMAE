...
class Mesh_baseline_seg(nn.Module):
    def __init__(self, masking_ratio=0.5, channels=13, num_heads=12, encoder_depth=12, embed_dim=768,
                 decoder_num_heads=16, decoder_depth=6, decoder_embed_dim=512,
...
class Mesh_cmae(nn.Module):
    ...
    def forward(self, faces, feats, centers, Fs, cordinates, faces2, feats2, centers2, Fs2, cordinates2):
        ...
        encoded_tokens = self.max_pooling2(encoded_tokens) # Shape will be (32, 1, 384)
        encoded_tokens = encoded_tokens.squeeze(1) # Shape becomes (32, 384)
